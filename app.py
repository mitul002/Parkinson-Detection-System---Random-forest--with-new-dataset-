...
def main():
    ...
    st.warning("""
    **This spiral-drawing–based Parkinson's screening system is not a medical or diagnostic tool and should not be considered 100% accurate.** 
    
    The output represents only a preliminary indication based on subtle motor-pattern analysis and may produce false positives or false negatives. Results can vary due to factors such as drawing conditions, device quality, user fatigue, or data variability. 
    
    This system is intended solely for research, educational, and clinical-support purposes. It does not replace professional medical judgment. 
    
    **Any indication of Parkinson's generated by this system must be followed by a full clinical evaluation by a qualified neurologist and appropriate diagnostic tests.**
    """)
